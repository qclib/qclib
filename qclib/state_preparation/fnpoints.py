...
class FnPointsInitialize(InitializeSparse):
    ...
    def _define_initialize(self):
        ...
        for idx_p, (input_z, output_s) in list(enumerate(self.params))[::-1]:
            ...
            self._apply_smatrix(circuit, idx_p, self.n_output_values, output_s.real, reg_c)
    ...
    def initialize(q_circuit, state, qubits=None, opt_params=None):
        if qubits is None:
            q_circuit.append(FnPointsInitialize(state, opt_params=opt_params), q_circuit.qubits)
        else:
