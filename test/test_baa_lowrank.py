...
class TestBaaLowRank(TestCase):
    ...
    def _test_initialize_loss(
        ...
        opt_params = {
            "max_fidelity_loss": fidelity_loss,
            "strategy": strategy,
    ...
    def test_initialize_loss_brute_force_low_rank(self):
        for loss in range(5, 15):
            self._test_initialize_loss(
                loss / 100, n_qubits=5, strategy="brute_force", use_low_rank=True
            )
    ...
    def test_initialize_loss_greedy_low_rank(self):
        for loss in range(5, 15):
            self._test_initialize_loss(
                loss / 100, n_qubits=5, strategy="greedy", use_low_rank=True
            )
    ...
    def test_initialize_loss_fixed_n3(self):
        ...
        for loss in [0.1, 0.28, 0.9]:
            self._test_initialize_loss(
                loss, state_vector=state_vector, strategy="brute_force"
            )
            self._test_initialize_loss(
                loss, state_vector=state_vector, strategy="greedy"
            )

    def test_initialize_loss_fixed_n4(self):
        state_vector = [
            0.04214906 + 0.25870366j,
            0.18263984 + 0.05596082j,
            0.17202687 + 0.1843925j,
            0.24972444 + 0.04666321j,
            0.03311006 + 0.28233458j,
            0.26680588 + 0.22211721j,
            0.07205056 + 0.04556719j,
            0.27982261 + 0.01626855j,
            0.22908475 + 0.25461504j,
            0.14290823 + 0.2425394j,
            0.14213592 + 0.08282699j,
            0.0068727 + 0.03378424j,
            0.2016483 + 0.298073j,
            0.07520782 + 0.0639856j,
            0.01026576 + 0.07669651j,
    ...
    def test_initialize_loss_fixed_n5(self):
        state_vector = [
            0.17777766 + 0.10171662j,
            0.19896424 + 0.10670792j,
            0.07982054 + 0.19653055j,
            0.18155708 + 0.05746777j,
            0.04259147 + 0.17093567j,
            0.21551328 + 0.08246133j,
            0.09549255 + 0.1117806j,
            0.20562749 + 0.12218064j,
            0.16191832 + 0.01653411j,
            0.12255337 + 0.14109365j,
            0.20090638 + 0.11119666j,
            0.19851901 + 0.04543331j,
            0.06842539 + 0.16671467j,
            0.03209685 + 0.16839388j,
            0.01707365 + 0.20060943j,
            0.03853768 + 0.08183117j,
            0.00073591 + 0.10084589j,
            0.09524694 + 0.18785593j,
            0.06005853 + 0.06977443j,
            0.01553849 + 0.05363906j,
            0.10294799 + 0.12558734j,
            0.20142903 + 0.06801796j,
            0.05282011 + 0.20879126j,
            0.11257846 + 0.20746226j,
            0.17737416 + 0.03461382j,
            0.01689154 + 0.06600272j,
            0.06428148 + 0.06199636j,
            0.1163249 + 0.160533j,
            0.14177201 + 0.10456823j,
            0.03156739 + 0.04567818j,
            0.02078566 + 0.02023752j,
            0.18967059 + 0.03469463j,
        ]
        state_vector = state_vector / np.linalg.norm(state_vector)
    ...
    def test_compare_strategies(self):
        ...
        for n_qubits in range(3, 7):
            ...
            for loss in range(10, 20):
                opt_params = {
                    "max_fidelity_loss": loss / 100,
                    "strategy": "brute_force",
                }

                circuit = BaaLowRankInitialize(
                    state_vector, opt_params=opt_params
                ).definition
                state = get_state(circuit)
